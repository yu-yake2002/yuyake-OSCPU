...
VL_MODULE(VSimTop___024unit) {
  ...
  public:
    ...
    void __Vdpiimwrap_v_difftest_ArchEvent_TOP____024unit(CData/*7:0*/ coreid, IData/*31:0*/ intrNo, IData/*31:0*/ cause, QData/*63:0*/ exceptionPC, QData/*63:0*/ exceptionInst);
